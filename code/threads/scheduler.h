...
class Scheduler {
  ...
  private:
    static int compare_by_priority(Thread* t1,Thread* t2);
    static int compare_by_bursttime(Thread* t1,Thread* t2);
    SortedList <Thread*> *readySJFList;
    SortedList <Thread*> *readyPriorityList; 
